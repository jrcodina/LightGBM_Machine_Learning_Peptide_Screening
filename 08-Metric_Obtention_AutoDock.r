...
Table_3.2 <- cbind(a,b,c)
Table_3.2 <- Table_3.2[,c(1, 2, 3, 7, 8, 4,5, 9, 10)]
Table_3.2 <- Table_3.2[c(4,5,6,2,1,3),]
Table_3.2[,-1] <- apply(Table_3.2[,-1], 2, function(x) round(x, 3))

write.csv(Table_3.2, "./Results/Table_3.2.csv", row.names = F)
write.csv(df, "./Results/Table_3.2_Full_Data.csv", row.names = F)