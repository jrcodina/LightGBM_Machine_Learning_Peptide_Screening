...
write.csv(all_best_affinities, row.names = F, "./20230717_Results_ADCP_Best.csv")

sequences <- read.csv("./tetra_G_selected.txt", header = F)
all_best_affinities <- cbind(Sequence = sequences[1:8000,], all_best_affinities)

write.csv(all_best_affinities, row.names = F, "./Table_S6.csv")
